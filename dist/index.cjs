...
var index = require('../lezer-tigerpython/dist/index');
...
const tigerPythonLanguage = language.LRLanguage.define({
    name: "python",
    parser: index.parser.configure({
        props: [
...
function tigerPython() {
    return new language.LanguageSupport(tigerPythonLanguage, [
...
exports.tigerPython = tigerPython;
exports.tigerPythonLanguage = tigerPythonLanguage;
